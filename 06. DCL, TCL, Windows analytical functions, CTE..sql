...
create user "mayur"@"localhost" identified by "mayur1" ;

grant select on batch.course to "mayur"@"localhost" ;

grant all on batch.course to "mayur"@"localhost" ;

grant all on batch.* to  "mayur"@"localhost" ;

revoke select on batch.course from "mayur"@"localhost" ;

revoke all on batch.course from  "mayur"@"localhost" ;

revoke all on batch.* from "mayur"@"localhost" ;
